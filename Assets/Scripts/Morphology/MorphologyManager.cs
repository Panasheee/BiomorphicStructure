...
namespace BiomorphicSim.Morphology
{
    ...
    public class MorphologyManager : MonoBehaviour
    {
        ...
        {
            // Breaking circular reference with NonSerialized attribute
            [System.NonSerialized]
            public GameObject gameObject;
            
            // Store GameObject ID instead for serialization
            public int gameObjectInstanceID;
            
            // Mark connections as non-serialized to break circular reference
            [System.NonSerialized] 
            ...
            public BiomorphNode(GameObject nodeObject, bool root = false)
            {
                ...
                if (nodeObject != null)
                    gameObjectInstanceID = nodeObject.GetInstanceID();
                isRoot = root;
        ...
        public class BiomorphConnection
        {
            ...
            // Break circular reference by not serializing the node references
            [System.NonSerialized]
            public BiomorphNode nodeA;
            [System.NonSerialized]
            public BiomorphNode nodeB;
            
            // Store indices instead of direct references for serialization
            ...
            public BiomorphConnection(GameObject connectionObject, BiomorphNode a, BiomorphNode b, float connectionStrength)
            {
                ...
                if (connectionObject != null)
                    gameObjectInstanceID = connectionObject.GetInstanceID();
                nodeA = a;
                nodeB = b;
            ...
            public void UpdateVisual()
            {
                if (gameObject == null || nodeA == null || nodeB == null || 
                    nodeA.gameObject == null || nodeB.gameObject == null)
                    return;
                ...
                try {
                    ...
                    Debug.LogWarning($"Error updating connection visual: {ex.Message}");
                }
            }
        }
